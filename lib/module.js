 ...
 */
const cmsEngineModule = function (moduleOptions) {
...
module.exports = cmsEngineModule
module.exports.CmsEnginePage = require('./src/CmsEnginePage.vue')
module.exports.CmsEngineUtils = require('./src/utils.js')
